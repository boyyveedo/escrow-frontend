      ...
      >
        <Menu>
          ...
          <MenuItems
            transition
            anchor="bottom end"
            className="w-[20.2rem] origin-top-right rounded-xl border border-borderColor text-sm/6 transition duration-200 ease-out [--anchor-gap:var(--spacing-1)] focus:outline-none data-[closed]:scale-95 data-[closed]:opacity-0"
          >
            <MenuItem>
              {(
                ...
                <>
                  <div className="grid h-28 w-[20rem] grid-cols-4 gap-5 rounded-lg bg-primary p-4 px-6 text-sm shadow-md">
                    <label
                      onClick={() => {
                        dispatch(
                          updateSendMessageData({
